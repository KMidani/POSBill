...
class RegisterViewController: UIViewController {
    ...
    @IBAction func showTaxes() {
        ...
        vc.doneCallback = {
            self.viewModel.updateBill()
            self.updateBillLabels()
        }
    ...
    func updateBillLabels(){
        let billDetail = viewModel.getBillDetail()
        subtotalLabel.text = billDetail.subTotal
        taxLabel.text = billDetail.taxTotal
        discountsLabel.text = billDetail.discountTotal
        totalLabel.text = billDetail.total
    }
}
